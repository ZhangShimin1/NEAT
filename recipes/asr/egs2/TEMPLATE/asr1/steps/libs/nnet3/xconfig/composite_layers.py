...
class XconfigTdnnfLayer(XconfigLayerBase):
    ...
    def _generate_config(self):
        ...
        configs.append(
            "component-node name={0}.linear component={0}.linear input={1}".format(
        ...
        configs.append(
            "component-node name={0}.relu component={0}.relu input={0}.affine".format(
                name
            )
        )
        ...
        # The BatchNorm layer
        configs.append(
            "component name={0}.batchnorm type=BatchNormComponent dim={1}".format(
                name, output_dim
            )
        )
        configs.append(
        ...
        if bypass_scale != 0.0:
            ...
            # in the network.
            configs.append(
                "component name={0}.noop type=NoOpComponent dim={1}".format(
                    name, output_dim
                )
            )
            configs.append(
...
class XconfigPrefinalLayer(XconfigLayerBase):
    ...
    def _generate_config(self):
        ...
        configs.append(
            "component-node name={0}.affine component={0}.affine input={1}".format(
                name, input_descriptor
            )
        )
        ...
        configs.append(
            "component name={0}.batchnorm1 type=BatchNormComponent dim={1}".format(
                name, big_dim
            )
        )
        configs.append(
        ...
        configs.append(
            "component name={0}.batchnorm2 type=BatchNormComponent dim={1}".format(
                name, small_dim
            )
        )
        configs.append(
