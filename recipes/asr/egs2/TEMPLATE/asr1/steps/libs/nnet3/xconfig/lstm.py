...
class XconfigLstmLayer(XconfigLayerBase):
    ...
    def _generate_lstm_config(self):
        ...
        configs.append(
            "component name={0}.c type=BackpropTruncationComponent dim={1} {2}".format(
        ...
        configs.append(
            "component name={0}.r type=BackpropTruncationComponent dim={1} {2}".format(
                name, cell_dim, bptrunc_str
            )
        )
        configs.append(
...
class XconfigLstmpLayer(XconfigLayerBase):
    ...
    def _generate_lstm_config(self):
        ...
        configs.append(
            "component-node name={0}.rp_t component={0}.W_rp.m input={0}.m_t".format(
                name
            )
        )
        configs.append(
...
class XconfigFastLstmpLayer(XconfigLayerBase):
    ...
    def _generate_lstm_config(self):
        ...
        configs.append(
            "dim-range-node name={0}.r input-node={0}.rp dim-offset=0 dim={1}".format(
                name, rec_proj_dim
            )
        )
