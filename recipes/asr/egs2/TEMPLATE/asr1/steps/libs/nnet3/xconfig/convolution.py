    ...
    def _generate_cnn_config(self):
        ...
        for operation in operations:
            if operation == "conv":
                ...
                configs.append(
                    "component-node name={0}.conv component={0}.conv input={1}".format(
                        name, cur_descriptor
                    )
                )
                ...
                configs.append(
                    "component-node name={0}.relu component={0}.relu input={1}".format(
                        name, cur_descriptor
                    )
                )
                ...
                configs.append(
                    "component-node name={0}.so component={0}.so input={1}".format(
                        name, cur_descriptor
                    )
                )
            else:
